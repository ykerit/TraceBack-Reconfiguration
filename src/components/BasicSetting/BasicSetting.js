...
import AvatarChange  from "../BasicComponents/AvatarChange";
        ...
        >
          ...
          <Form.Item label="个性签名">
            {getFieldDecorator('signature', {
              rules: [{ required: true, message: '请输入签名!', whitespace: true }],
            })(
              <Input/>
            )
          ...
          <Form.Item label="个人简介">
            {getFieldDecorator('title', {
              rules: [{ required: true, whitespace: true, message: '请输入简介!' }],
            })(
              <Input.TextArea
              rows={4}
              />
          ...
          <Form.Item label="学历">
            {getFieldDecorator('group', {
              rules: [{ required: true, whitespace: true, message: '请输入学历!' }],
            })(
              <Input/>
            )}
          </Form.Item>
